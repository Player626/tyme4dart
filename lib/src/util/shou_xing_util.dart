...
/// 寿星天文历工具(参考https://sxwnl.github.io)
///
/// Author: 6tail
class ShouXingUtil {
  static const pi2 = 2 * math.pi;

  static const oneThird = 1 / 3;

  static const secondPerDay = 86400;

  static const secondPerRad = 648000 / math.pi;

  static const List<double> nutB = [2.1824, -33.75705, 36e-6, -1720, 920, 3.5069, 1256.66393, 11e-6, -132, 57, 1.3375, 16799.4182, -51e-6, -23, 10, 4.3649, -67.5141, 72e-6, 21, -9, 0.04, -628.302, 0, -14, 0, 2.36, 8328.691, 0, 7, 0, 3.46, 1884.966, 0, -5, 2, 5.44, 16833.175, 0, -4, 2, 3.69, 25128.110, 0, -3, 0, 3.55, 628.362, 0, 2, 0];
  static const List<double> dtAt = [
  ...
  static const List<List<double>> xl1 = [
    [
      22639.586,
      0.78475822,
      8328.691424623,
  ...
  static final String sb = _decode(
  ...
  static double nutationLon2(double t) {
    ...
    for (int i = 0, j = nutB.length; i < j; i += 5) {
  ...
  static double eLon(double t, int n) {
    ...
    for (int i = 0; i < 6; i++, tn *= t) {
      int n1 = xl0[1 + i].floor();
      int n2 = xl0[2 + i].floor();
      double n0 = n2 * 1.0 - n1;
      if (n0 == 0) {
        continue;
      }
    ...
    double t2 = t * t;
    return v / xl0[0] + (-0.0728 - 2.7702 * t - 1.1019 * t2 - 0.0996 * t2 * t) / secondPerRad;
  }

  static double mLon(double t, int n) {
    int obl0 = 2652;
    List<int> obl = [obl0, 893, 204, 12];
    double tn = 1;
    double v = 0;
    int j;
    double c = 0;
  ...
  static double dtCalc(double y) {
    int size = dtAt.length;
    double y0 = dtAt[size - 2];
    double t0 = dtAt[size - 1];
    if (y >= y0) {
      double jsd = 31;
      if (y > y0 + 100) {
        return dtExt(y, jsd);
    ...
    double t1 = (y - dtAt[i]) / (dtAt[i + 5] - dtAt[i]) * 10, t2 = t1 * t1, t3 = t2 * t1;
